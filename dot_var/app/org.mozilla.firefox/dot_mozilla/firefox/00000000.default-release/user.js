...
user_pref("browser.link.open_newwindow.restriction", 0); // enforce
...
user_pref("browser.urlbar.tipShownCount.searchTip_onboard", 4); // dismiss
user_pref("datareporting.healthreport.uploadEnabled", false);
user_pref("datareporting.policy.dataSubmissionEnabled", false);
user_pref("devtools.selfxss.count", 5); // allow pasting
user_pref("devtools.toolbox.host", "right");
user_pref("dom.popup_allowed_events", "click dblclick mousedown pointerdown");
user_pref("dom.security.https_only_mode", true);
user_pref("extensions.activeThemeID", "firefox-compact-dark@mozilla.org");
user_pref("extensions.autoDisableScopes", 0); // no restrictions
...
user_pref("services.sync.declinedEngines", "passwords,addresses,creditcards,prefs,addons");
